...
$string['tiles_placeholderimage'] = 'Placeholder image for courses without a course image';
$string['tiles_placeholderimage_desc'] = 'Shown in the tile view when a course has no overview image. Recommended: landscape, at least 400×200 px.';

$string['tilesettings_free_heading'] = 'Free tier';
$string['tilesettings_free_desc'] = 'Dashboard and My courses with standard layout (2 columns, default colours, no footer info).';
$string['tilesettings_premium_heading'] = 'Premium features';
$string['tilesettings_premium_desc'] = 'Front page, category pages, course search, placeholder image, tile info (progress, enrolment, course count), layout and colours.';
...
$string['license_error_premium_required'] = 'This setting requires a valid Premium license.';
...
$string['license_heading_desc'] = 'License key for Premium features. Without a valid license, free tier limits apply.';
